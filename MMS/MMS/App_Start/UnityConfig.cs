    ...
    public class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            container.RegisterType<IDataContextAsync, MPMSContext>(new PerRequestLifetimeManager())
                 ...
                 .RegisterType<IMessageSendVMService, MessageSendVMService>()
                ...
                .RegisterType<IStoredProcedures, MPMSContext>()
                 ...
                 .RegisterType<IMessageInfoService, MessageInfoService>()

                 .RegisterType<IRepositoryAsync<MessageInfo>, Repository<MessageInfo>>()

                  .RegisterType<IMessageAreaTypeService, MessageAreaTypeService>()

                 .RegisterType<IRepositoryAsync<MessageAreaType>, Repository<MessageAreaType>>()
                 ...
                 .RegisterType<IUserModuleService, UserModuleService>()
                  ...
                  .RegisterType<IRepositoryAsync<MessageMailMaster>, Repository<MessageMailMaster>>()
                 .RegisterType<IMessageMailMasterService, MessageMailMasterService>()

                     .RegisterType<IRepositoryAsync<MailInfo>, Repository<MailInfo>>()
                 .RegisterType<IMailInfoService, MailInfoService>()


                     .RegisterType<IRepositoryAsync<SendingAreaType>, Repository<SendingAreaType>>()
                 .RegisterType<ISendingAreaTypeService, SendingAreaTypeService>()


                     .RegisterType<IRepositoryAsync<ControlType>, Repository<ControlType>>()
                 .RegisterType<IControlTypeService, ControlTypeService>()

                    .RegisterType<IRepositoryAsync<CheckList>, Repository<CheckList>>()
                 .RegisterType<ICheckListService, CheckListService>()
